...
def parse_args():
    ...
    p.add_argument("--model", default="yolov12m.pt", help="Only used to derive the run-dir name stem.")
    ...
    p.add_argument("--project", default="rf100_runs_10ep", help="Where fine-tuned runs live.")
